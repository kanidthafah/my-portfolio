...
const TabsTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center w-full bg-[#2c3b4d] tracking-wider whitespace-nowrap text-white rounded-lg p-3 text-base font-medium ring-offset-white transition-all disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-[#ffb162] data-[state=active]:text-[#a35139] data-[state=active]:shadow-sm",
      className
    )}
    {...props}
  />
